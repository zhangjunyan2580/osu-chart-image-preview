...
public class Hold extends HitObject {
    ...
    public Hold(Vec2F pos, int time, int endTime, boolean newCombo, int soundType, int comboOffset, int sampleSet, int additionSet, int customSample, int volume, String customSampleFile) {
        this.pos = pos;
        this.time = time;
